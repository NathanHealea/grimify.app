...
- [x] [Edit user profile](./01-authentication-and-user-accounts/07-edit-user-profile.md)
...
- [ ] [Color wheel zoom — paint marker scaling](./03-interactive-color-wheel/04-color-wheel-zoom-marker-scale.md)
...
- [x] [Color distance algorithm and matching engine](./04-cross-brand-comparison/00-color-matching-engine.md)
- [x] [Side-by-side paint comparison UI](./04-cross-brand-comparison/01-comparison-ui.md)
- [x] [Substitute suggestions for discontinued paints](./04-cross-brand-comparison/02-substitute-suggestions.md)
- [x] [Similar paints on the paint detail page](./04-cross-brand-comparison/03-paint-detail-similar-paints.md)
- [ ] [Admin paint alternatives linking](./04-cross-brand-comparison/04-admin-paint-alternatives.md)
...
- [x] [Paint detail color schemes — brand filter](./05-color-scheme-explorer/06-paint-detail-brand-schemes.md)
...
- [x] [Admin profile editing](./08-user-management/03-admin-profile-editing.md)
- [x] [Profile and account merging](./08-user-management/04-profile-merging.md)
- [x] [User profile deletion (self-service)](./08-user-management/05-user-profile-deletion.md)
...
- [ ] [Palette paint search — show paint type](./11-color-palettes/17-palette-paint-search-show-type.md)
...
- [ ] [Recipe image thumbnails](./12-painting-recipes/08-recipe-image-thumbnails.md)
